...
printf "    4. After mounting external HDD, restore Borg repo key:\n"
printf "       ${DIM}borg key import /mnt/external_hdd/borg-repo ~/borg-key-backup.txt${NC}\n"
printf "       ${DIM}borgmatic check${NC}\n\n"
