...
| **nextcloud excluded — custom Dockerfile, update with: docker compose build --no-cache** | At 09:00 | `$S/cron-guard.py --mode fail "Dockcheck Update Checker" "$S/dockcheck/dockcheck.sh -mniIMx 10 -d 5 -e nextcloud"` |
