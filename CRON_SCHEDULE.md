...
| **cert-manager: regenerate & upload SSL certs to NPM** | At 03:00, on day 1 of the month | `$S/cron-guard.py --mode all "cert-mgr: Renew SSL certs" "$S/cert-manager/cert-manager.sh regen"` |
