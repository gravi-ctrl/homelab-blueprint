...
| `gitops-deploy.sh` | Monitors /opt/stacks for remote Codeberg changes done by Renovate and auto-deploys updated compose stacks. | Every 15 minutes | — | `STACKS_DIR` `TELEGRAM_CHAT_ID` `TELEGRAM_DANTE_BOT_TOKEN` |
